    ...
    return (
      <div className="ml-36 mt-10 flex justify-evenly flex-wrap">
        ...
        {open && (
          ...
          >
            <RoadmapForm roadmap={roadmap} method='post'  id={location.state.id} closeForm={closeForm} />
          </dialog>
        )}
        {editopen&& (
          <dialog
            ...
            className="flex items-center justify-center flex-col w-96  p-2"
          >
            <RoadmapForm roadmap={roadmap} method='put' id={location.state.id} closeForm={closeForm} />
          </dialog>
        )}
        {
            deleteopen &&
            <RoadmapDeleteForm deletedialogRef={deletedialogRef} closeDeleteHandler={closeDeleteHandler} roadmap={roadmap}/>
        }
      </div>
    );
}
