...
const getConnectedUser=async (setResult:Dispatch<SetStateAction<Array<Pick<userProps,'_id'|'email'|'profileImage'>>>>,onlineDataRef:RefObject<Record<string,boolean>>)=>{
    const response=
    (
